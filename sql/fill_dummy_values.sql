...
VALUES
    (UUID(), 'iPhone 13', 'Apple', 'Smartphones', 'Latest iPhone model', 100, 999.99),
    (UUID(), 'Galaxy S21', 'Samsung', 'Smartphones', 'Latest Samsung Galaxy model', 100, 899.99),
    (UUID(), 'MacBook Pro', 'Apple', 'Laptops', 'Latest MacBook model', 100, 1299.99),
    (UUID(), 'Galaxy Book Pro', 'Samsung', 'Laptops', 'Latest Samsung laptop model', 100, 1199.99),
    (UUID(), 'AirPods Pro', 'Apple', 'Audio', 'Wireless earbuds with noise cancellation', 50, 249.99),
    (UUID(), 'WH-1000XM4', 'Sony', 'Audio', 'Over-ear headphones with superior noise cancellation', 75, 349.99),
    (UUID(), 'Smart TV', 'LG', 'Video', 'High-definition television with smart features', 20, 599.99),
    (UUID(), 'Playstation 5', 'Sony', 'Gaming', 'Next-generation video game console', 25, 499.99),
    (UUID(), 'Wireless Router', 'Netgear', 'Networking', 'High-speed wireless router for home networks', 30, 99.99),
    (UUID(), 'Microsoft Office Suite', 'Microsoft', 'Software', 'Productivity software for home and business use', 100, 149.99),
    (UUID(), 'Google Nest', 'Google', 'Smart Home', 'Voice-activated speaker for smart home control', 40, 99.99),
    (UUID(), 'Lenovo Tab M10', 'Lenovo', 'Tablets', 'Android tablet for entertainment and productivity', 60, 299.99);
